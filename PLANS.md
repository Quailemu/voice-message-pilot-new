...
The public home page should stay minimal during the current stage: brand name, a short access-by-invitation explanation, and existing sign-in routes only. Detailed product notes, cartoons, infographics, FAQs, and support documents should not be browsable from the public site while the product is being introduced privately.
